...
async function main() {
  try {
    ...
    console.log("Checking ETH token address for the testnet...");
    ...
    console.log(
      `Game created with entry fee ${ethers.formatEther(
        entryFee
      )} ETH and round duration ${roundDuration} seconds`
    );
    ...
    const memeData = [
      ...
      {
        name: "Pepe on Base",
        description: "Pepe swimming in a Base blockchain",
        tokenName: "BasePepe",
        tokenSymbol: "BPEPE",
        uniqueId: "pepe456",
      ...
      {
        name: "Wojak Trading",
        description: "Wojak looking at Base charts",
      ...
      },
      {
        ...
        description: "Guy looking at Base chain instead of Ethereum",
      ...
      {
        name: "Stonks on Base",
        description: "Stonks guy investing in Base",
        tokenName: "BaseStonks",
        tokenSymbol: "BSTONK",
        uniqueId: "stonks202",
        imageUrl: "https://ipfs.io/ipfs/QmExample5",
      },
      {
        name: "This is Fine Base",
        description: "This is fine dog in a Base blockchain fire",
    ...
    for (let i = 0; i < memeSubmitters.length; i++) {
      ...
      try {
        ...
        try {
          // First approve the contract to spend ETH tokens
          // const ethTokenAddress = "0x7b79995e5f793A07Bc00c21412e50Ecae098E7f9"; // Replace with actual ETH token address
          // const ethToken = new ethers.Contract(
          //   ethTokenAddress,
          //   [
          ...
          //   contractAddress,
          //   ethers.parseEther("30"), // 30 ETH tokens
          //   {
          //     gasLimit: 200000,
          //     gasPrice: ethers.parseUnits("10", "gwei"),
          //   }
    ...
    console.log(`Prize Pool: ${ethers.formatEther(gameInfo[2])} ETH`);
    ...
    console.log(`Entry Fee: ${ethers.formatEther(gameInfo[7])} ETH`);
